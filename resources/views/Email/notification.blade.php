                        ...
                        <tbody>
                            <tr>
                                <td style="text-align: center; padding:25px 20px 0;">
                                    <p style="font-size: 13px;">Copyright © 2022 PT. Media Antar Nusa. All rights
                                        reserved. <br>
                                    </p>
                                </td>
                            </tr>
                    ...
                    <table style="width:100%;max-width:620px;margin:0 auto;background-color:#ffffff;">
                        <tbody>
                            <tr>
                                <td style="text-align:center;padding: 50px 30px;">
                                    <h2
                                        style="font-size: 18px; color: #6576ff; margin-bottom: 8px; font-weight: bolder;">
                                        Hi, {{ $notif_receiever }}
                                    </h2>
                                    <p style="font-size: 15px; color: #6576ff; margin-bottom: 8px;">
                                        Data pelanggan <b>{{ $customer_name }}</b> telah {{ $status }} oleh
                                        <b>{{ $notif_sender }}</b>
                                    </p>
                                    <p style="text-align: justify;">
                                        {{ $message_body }}
                            ...
                            <tr>
                                <td style="text-align: center; padding:25px 20px 0;">
                                    <p style="font-size: 13px;">
                                        Copyright © {{ date('Y') }} PT. Media Antar Nusa. All rights reserved.
                                        <br>
                                    </p>
                                </td>
                            </tr>
