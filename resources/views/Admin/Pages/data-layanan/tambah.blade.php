                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ URL::to('data-layanan') }}" method="POST">
                                    @csrf
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            placeholder="Masukkan nama paket..." value="{{ old('package_categories') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number"
                                                ...
                                                name="package_speed" value="{{ old('package_speed') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control"
                                                ...
                                                id="retail_package_price" value="{{ old('retail_package_price') }}">
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control"
                                                ...
                                                value="{{ old('government_package_price') }}">
                                        </div>
                                    </div>
                                    <div class="mb-3">
