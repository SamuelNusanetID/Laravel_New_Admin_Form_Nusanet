                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ URL::to('data-promo/' . $dataPromo->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('promo_name') is-invalid @enderror"
                                            ...
                                            value="{{ old('promo_name', $dataPromo->promo_name) }}">
                                        @error('promo_name')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('branch_id') is-invalid @enderror"
                                            ...
                                            @foreach ($branchList as $item)
                                                @if (old('branch_id', $dataPromo->branch_id) == $item['branch_code'])
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('package_name') is-invalid @enderror"
                                            ...
                                            @foreach ($packageList as $item)
                                                @if (old('package_name', $dataPromo->package_name) == $item)
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('package_top') is-invalid @enderror"
                                            ...
                                            @foreach ($jangkaWaktu as $item)
                                                @if (old('package_top', $dataPromo->package_top) == $item)
                                                    <option value="{{ $item }}" selected>
                                                        {{ $item }}
                                                    </option>
                                                @else
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number"
                                                ...
                                                value="{{ old('discount_cut', $dataPromo->discount_cut) }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number"
                                                ...
                                                value="{{ old('monthly_cut', $dataPromo->monthly_cut) }}">
                                            <span class="input-group-text bg-success text-white"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('monthly_cut_status') is-invalid @enderror"
                                            ...
                                            @foreach ($monthlyStat as $item)
                                                @if (old('monthly_cut_status', $dataPromo->monthly_cut_status) == $item)
                                                    <option value="{{ $item }}" selected>
                                                        {{ $item }}
                                                    </option>
                                                @else
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('promo_desc') is-invalid @enderror" id="promo_desc" name="promo_desc"
                                            rows="5" placeholder="Masukkan Deskripsi Promo...">{{ old('promo_desc', $dataPromo->promo_desc) }}</textarea>
                                        @error('promo_desc')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('promo_status') is-invalid @enderror"
                                            ...
                                            @foreach ($monthlyStat as $item)
                                                @if (old('promo_status', $dataPromo->promo_status) == $item)
                                                    <option value="{{ $item }}" selected>
                                                        {{ $item }}
                                                    </option>
                                                @else
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="datetime-local"
                                            ...
                                            value="{{ old('activate_date', $dataPromo->activate_date) }}">
                                        @error('activate_date')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="datetime-local"
                                            ...
                                            value="{{ old('expired_date', $dataPromo->expired_date) }}">
                                        @error('expired_date')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
