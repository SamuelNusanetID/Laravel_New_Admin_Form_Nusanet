...
@section('auth-wrapper')
    <div style="height: 19em; overflow: -moz-scrollbars-vertical; overflow-y: scroll;">
        <p class="text-center">Silahkan daftar akun anda</p>
        ...
        <form action="{{ URL::to('register') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="password" class="form-control @error('password') is-invalid @enderror"
                    id="password_confirmation" name="password_confirmation" placeholder="Masukkan ulang password anda..."
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('employee_id') is-invalid @enderror" id="employee_id"
                    name="employee_id" placeholder="Masukkan ulang password anda..." value="{{ old('email') }}">
                @error('employee_id')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('employee_name') is-invalid @enderror"
                    id="employee_name" name="employee_name" placeholder="Masukkan ulang password anda..."
            ...
            <p class="text-center">Sudah memiliki akun? Klik <a href="{{ URL::to('login') }}">disini</a></p>
        </form>
    </div>
@endsection
